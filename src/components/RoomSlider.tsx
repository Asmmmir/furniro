    ...
    return (
        <div className="bg-[#FCF8F3] mt-20">
            <div className="relative max-w-[1440px] mx-auto p-5 flex max-md:flex-col items-center justify-center gap-[42px] overflow-hidden font-poppins">
                ...
                <div className="flex items-center justify-start gap-3 snap-mandatory snap-x overflow-x-scroll flex-1" ref={sliderRef}>
                    {showLeftButton && (
                    ...
                    <img className="snap-center" src="./images/slider/2.jpg" alt="" />
                    <img className="snap-center" src="./images/slider/3.jpg" alt="" />
                    <img className="snap-center" src="./images/slider/2.jpg" alt="" />
                    <img className="snap-center" src="./images/slider/2.jpg" alt="" />
                    <img className="snap-center" src="./images/slider/2.jpg" alt="" />
                    <img className="snap-center" src="./images/slider/2.jpg" alt="" />
